...
- (void)buildTextViews
{
    if (!self.editorView) {
        ...
        self.titlePlaceholderText = NSLocalizedString(@"Guide title",  @"Placeholder for the post title.");
        self.bodyPlaceholderText = NSLocalizedString(@"Create your guide here...", @"Placeholder for the post body.");
    }
